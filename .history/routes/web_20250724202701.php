...
Route::middleware(['web'])->group(function () {
    ...
    Route::get('/shopping-export', [ShoppingController::class, 'export'])->name('shopping.export');
});
...
Route::get('/upload-receipt', [ReceiptController::class, 'showForm']);
Route::post('/upload-receipt', [ReceiptController::class, 'uploadImage']);