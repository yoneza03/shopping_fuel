        ...
        <form id="comparison-form">
            <div class="d-flex justify-content-between gap-4">
                ...
                <div class="form-section">
                    <input type="number" id="price_left" class="form-control mb-4" placeholder="価格">
                    <input type="number" id="volume_left" class="form-control mb-4" placeholder="容量">
                    <select id="unit_left" class="form-select mb-4">
