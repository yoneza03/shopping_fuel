...
<div class="container">
  ...
  <form action="{{ route('fuel.store') }}" method="POST">
    ...
    <div class="mb-3">
      <label class="form-label">単価（円/L）</label>
      <input type="number" name="fuel_price" class="form-control" step="0.01">
    </div>

    <div class="mb-3">
      <label class="form-label">支払金額（円）</label>
      <input type="number" name="total_cost" class="form-control" step="0.01">
    </div>

    <div class="mb-3">
      <label class="form-label">備考</label>
      <input type="text" name="note" class="form-control" placeholder="例：洗車付き、遠出したなど">
    </div>
