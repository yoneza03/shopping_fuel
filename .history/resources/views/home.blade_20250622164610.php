    ...
    <form id="comparison-form">
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div class="form-section mb-5">
                <input type="number" id="price_left" class="form-control md-5" placeholder="価格">
                <input type="number" id="volume_left" class="form-control md-5" placeholder="容量">
            ...
            <!-- 右側入力 -->
            <div class="form-section mb-5">
                <input type="number" id="price_right" class="form-control md-5" placeholder="価格">
                <input type="number" id="volume_right" class="form-control md-5" placeholder="容量">
