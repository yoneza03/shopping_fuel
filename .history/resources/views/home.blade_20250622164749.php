    ...
    <form id="comparison-form">
        <div class="d-flex justify-content-between flex-wrap">
            ...
            <div class="form-section mb-3">
                <input type="number" id="price_left" class="form-control md-2" placeholder="価格">
                <input type="number" id="volume_left" class="form-control md-2" placeholder="容量">
            ...
            <!-- 計算ボタン -->
            <div class="d-flex align-items-center justify-content-center mb-3 mx-3">
            ...
            <!-- 右側入力 -->
            <div class="form-section mb-3">
                <input type="number" id="price_right" class="form-control md-2" placeholder="価格">
                <input type="number" id="volume_right" class="form-control md-2" placeholder="容量">
